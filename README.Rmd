...
For the statistical side of thing, you can start by calculating the hedge area in total area and as percantage towards the hexagon area.
...
```{r outside points nearest hedge}
