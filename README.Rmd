...
| Overall connectivity index for hedges | But only if feasable and sensible |
| Integrating other packages | i.e. landscapemetrcis |
| Integrating tests | i.e. with testthis() |
