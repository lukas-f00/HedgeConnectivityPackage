...
You can install the development version of HedgeConnectivityPackage from GitHub using:
...
If you find a bug or want to suggest an improvement, feel free to open an issue or pull request on GitHub. Also if you want to contribute towards the package, also feel free to contact me! :)
